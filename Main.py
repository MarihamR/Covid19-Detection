...
def main(model,Trainloader,Testloader,loss_fn,optimizer,lr,name=None,epochs=10,
         Test=False,scheduler_bol=False,nodisplay=False,sch_gamma=0.1,sch_step=5,save_weights=False,device='cuda'):
